...
def build_targets(model, targets):
    ...
    for i in model.yolo_layers:
        ...
        if multi_gpu:
            if model.deploy==False:
                ng, anchor_vec = model.module.module_list[i+84].ng, model.module.module_list[i+84].anchor_vec
            else:
                ng, anchor_vec = model.module.module_list[i+28].ng, model.module.module_list[i+28].anchor_vec
        else:
            if model.deploy==False:
                ng, anchor_vec = model.module_list[i+84].ng, model.module_list[i+84].anchor_vec
            else:
                ng, anchor_vec = model.module_list[i+28].ng, model.module_list[i+28].anchor_vec
